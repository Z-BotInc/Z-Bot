...
module.exports.run = async (bot, message, args, db) => {
    ...
    let embed = new Discord.MessageEmbed()
        ...
        .addField("Date de création", `\`\`\`js\n${(member.user.createdAt.getDay()+1).toString().replace("1", "Lundi").replace("2", "Mardi").replace("3", "Mercredi").replace("4", "Jeudi").replace("5", "Vendredi").replace("6", "Samedi").replace("7", "Dimanche")} ${member.user.createdAt.getDate()} ${member.user.createdAt.getMonth().toString().replace("10", "Novembre").replace("11", "Décembre").replace("0", "Janvier").replace("1", "Février").replace("2", "Mars").replace("3", "Avril").replace("4", "Mai").replace("5", "Juin").replace("6", "Juillet").replace("7", "Août").replace("8", "Septembre").replace("9", "Octobre")} ${member.user.createdAt.getFullYear()}\`\`\``)
        .addField("Date d'arrivée",  `\`\`\`js\n${(member.joinedAt.getDay()+1).toString().replace("1", "Lundi").replace("2", "Mardi").replace("3", "Mercredi").replace("4", "Jeudi").replace("5", "Vendredi").replace("6", "Samedi").replace("7", "Dimanche")} ${member.joinedAt.getDate()} ${member.joinedAt.getMonth().toString().replace("10", "Novembre").replace("11", "Décembre").replace("0", "Janvier").replace("1", "Février").replace("2", "Mars").replace("3", "Avril").replace("4", "Mai").replace("5", "Juin").replace("6", "Juillet").replace("7", "Août").replace("8", "Septembre").replace("9", "Octobre")} ${member.joinedAt.getFullYear()}\`\`\``)
